...
public class CardsController {
    ...
    public ResponseEntity<CardsDto> fetchCardDetails(@RequestHeader("banking-correlation-id") String correlationId,
        ...
        return ResponseEntity
                ...
                .body(iCardsService.fetchCard(mobileNumber, correlationId));
    }
    ...
    @Operation(
            ...
            description = "Fetch Build information that is deployed into cards microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Fetch Java version that is installed into cards microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
